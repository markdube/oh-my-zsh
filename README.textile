...
@curl -L https://raw.github.com/markdube/oh-my-zsh/master/tools/install.sh | sh@

h4. via `wget`

@wget --no-check-certificate https://raw.github.com/markdube/oh-my-zsh/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone https://github.com/markdube/oh-my-zsh.git ~/.oh-my-zsh@
